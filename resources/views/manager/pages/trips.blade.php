...
<div class="bg-white rounded-xl shadow-md overflow-hidden">
    <div class="bg-gradient-to-r from-purple-600 to-indigo-600 p-6 text-white flex justify-between items-center">
        ...
        <a href="{{ route('trips.create') }}" class="bg-white text-purple-600 px-4 py-2 rounded-lg font-semibold hover:bg-gray-100 transition-colors">
                    ...
                    <tr class="hover:bg-gray-50">
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                            <div class="flex justify-end space-x-2">
                                <a href="{{ route('destinations.show', Str::slug(explode(',', $trip->destination)[0])) }}" class="text-indigo-600 hover:text-indigo-900" title="View Destination">
                                    <i class="fas fa-eye"></i>
                                </a>
                                <a href="{{ route('manager.collaborations', $trip->id) }}" class="text-blue-600 hover:text-blue-900" title="Manage Collaborations">
                                    <i class="fas fa-users-cog"></i>
                                </a>
                                <a href="{{ route('manager.trips.edit', $trip->id) }}" class="text-yellow-600 hover:text-yellow-900" title="Edit">
                                    <i class="fas fa-edit"></i>
                                </a>
                                <form action="{{ route('trips.destroy', $trip->id) }}" method="POST" class="inline-block" onsubmit="return confirm('Are you sure you want to delete this trip?');">
                                    @csrf
                                    @method('DELETE')
                    ...
                    <tr>
                        <td colspan="5" class="px-6 py-10 text-center text-gray-500">
                            <div class="flex flex-col items-center">
                                ...
                                <a href="{{ route('trips.create') }}" class="bg-purple-500 text-white px-4 py-2 rounded-lg font-semibold hover:bg-purple-600 transition-colors">
