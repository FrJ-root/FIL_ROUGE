...
<div class="flex items-center justify-between mb-8">
    <h1 class="text-3xl font-bold text-gray-800 flex items-center">
        <i class="fas fa-suitcase-rolling text-hotel-blue mr-3"></i>
        Your Trips
    </h1>
    <a href="{{ route('hotel.available-trips') }}" class="bg-hotel-green hover:bg-green-600 text-white font-bold py-2 px-4 rounded-lg transition-colors duration-300 flex items-center">
...
<div class="bg-white rounded-xl shadow-lg overflow-hidden">
                    ...
                    @foreach($trips as $trip)
                        <tr class="hover:bg-gray-50">
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="flex items-center">
                                    <div class="flex-shrink-0 h-10 w-10 bg-gray-100 rounded-lg flex items-center justify-center">
                                        <i class="fas fa-map-marker-alt text-hotel-blue"></i>
                                    </div>
                                    <div class="ml-4">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                <a href="{{ route('hotel.trip.details', $trip->id) }}" class="text-hotel-blue hover:text-blue-900 mr-3">
                                    <i class="fas fa-eye"></i> View
                                </a>
                                <form action="{{ route('hotel.withdraw-trip', $trip->id) }}" method="POST" class="inline-block">
                                    @csrf
    ...
    @else
        <div class="text-center py-12">
            ...
            <a href="{{ route('hotel.available-trips') }}" class="bg-hotel-blue text-white px-6 py-3 rounded-lg hover:bg-blue-600 transition-colors">
