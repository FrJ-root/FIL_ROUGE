...
<div class="flex items-center justify-between mb-6">
    <a href="{{ route('hotel.trips') }}" class="flex items-center text-gray-600 hover:text-hotel-blue">
        <i class="fas fa-arrow-left mr-2"></i> Back to Trips
    </a>
    
    @if(!$isAssigned)
        <form action="{{ route('hotel.join-trip') }}" method="POST">
            @csrf
            <input type="hidden" name="trip_id" value="{{ $trip->id }}">
            <button type="submit" class="bg-hotel-green hover:bg-green-600 text-white font-bold py-2 px-4 rounded-lg transition-colors duration-300">
                <i class="fas fa-check mr-2"></i> Join This Trip
            </button>
        </form>
    @else
        <form action="{{ route('hotel.withdraw-trip', $trip->id) }}" method="POST">
            @csrf
    ...
    <div class="p-6">
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div class="md:col-span-2">
                                ...
                                <div class="flex justify-between items-start">
                                    <div>
                                        ...
                                        <p class="text-gray-600 text-sm">
                                            <i class="fas fa-map-marker-alt text-hotel-red mr-1"></i>
                                            {{ $activity->location }}
                                        </p>
                ...
                <h3 class="font-bold text-lg mb-3">Accommodations Required</h3>
                <div class="bg-blue-50 p-4 rounded-lg border border-blue-100">
                    <p class="text-blue-800">
                        <i class="fas fa-info-circle mr-2"></i>
                        This trip needs accommodation for {{ $trip->travellers->count() }} travellers from 
                    ...
                    @if($isAssigned)
                        <div class="mt-3 bg-green-100 p-3 rounded-lg">
                            <p class="text-green-700 flex items-center">
                                ...
                                You are assigned as an accommodation provider for this trip.
                            </p>
                        </div>
                    @endif
                </div>
                ...
                <div class="bg-gray-50 rounded-lg p-4 mb-6">
                    ...
                    <ul class="space-y-2">
                        <li class="flex items-start">
                            <i class="fas fa-map-marker-alt text-hotel-blue mt-1 mr-3 w-5 text-center"></i>
                            <div>
                        ...
                        <li class="flex items-start">
                            <i class="fas fa-calendar-alt text-hotel-blue mt-1 mr-3 w-5 text-center"></i>
                            <div>
                        ...
                        <li class="flex items-start">
                            <i class="fas fa-clock text-hotel-blue mt-1 mr-3 w-5 text-center"></i>
                            <div>
                        ...
                        <li class="flex items-start">
                            <i class="fas fa-users text-hotel-blue mt-1 mr-3 w-5 text-center"></i>
                            <div>
